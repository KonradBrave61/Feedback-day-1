...
// Multi-select manager selector (1-3), UI consistent with CoachSelector
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] text-white border" style={{ background: logoColors.backgroundGradient, borderColor: logoColors.primaryBlueAlpha(0.2) }}>
        <DialogHeader>
          ...
          <p className="text-gray-300">Pick 1-3 managers. Display and card style matches coaches.</p>
        </DialogHeader>
