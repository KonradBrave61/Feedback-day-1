      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Tabs defaultValue="guides" className="w-full">
          <TabsList className="grid w-full grid-cols-4 mb-8"
            ...
            <TabsTrigger value="tips" className="text-white border border-transparent rounded-md hover:border-blue-400/40 data-[state=active]:bg-blue-500 data-[state=active]:text-black data-[state=active]:border-blue-400">
              Tips & Strategies
            </TabsTrigger>
          ...
          <TabsContent value="guides" className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              <Card className="backdrop-blur-lg text-white border-0"
                ...
                <CardContent className="p-0">
                  <button
                    className={`w-full p-6 text-left flex items-center justify-between transition-colors rounded-md border ${expandedSection === 'formation' ? 'bg-white/5 border-blue-400/40' : 'hover:bg-white/5 border-transparent'}`}
              ...
              <Card className="backdrop-blur-lg text-white border-0"
                ...
                <CardContent className="p-0">
                  <button
                    className={`w-full p-6 text-left flex items-center justify-between transition-colors rounded-md border ${expandedSection === 'stats' ? 'bg-white/5 border-blue-400/40' : 'hover:bg-white/5 border-transparent'}`}
              ...
              <Card className="backdrop-blur-lg text-white border-0"
                ...
                <CardContent className="p-0">
                  <button
                    className={`w-full p-6 text-left flex items-center justify-between transition-colors rounded-md border ${expandedSection === 'equipment' ? 'bg-white/5 border-blue-400/40' : 'hover:bg-white/5 border-transparent'}`}
