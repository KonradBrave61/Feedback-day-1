...
const TechniquesPage = () => {
  ...
  const getBackendUrl = () => {
    ...
    return process.env.REACT_APP_BACKEND_URL || 'https://content-security-fix.preview.emergentagent.com';
  };
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select value={filters.category || undefined} onValueChange={(v) => handleFilterChange('category', v === 'all' ? '' : v)}>
                      ...
                      <SelectContent style={{ backgroundColor: logoColors.blackAlpha(0.9), borderColor: logoColors.primaryBlueAlpha(0.3) }}>
                        <SelectItem value="all" className="text-white hover:opacity-80 focus:bg-transparent data-[highlighted]:bg-transparent" style={{ backgroundColor: logoColors.primaryBlueAlpha(0.1) }}>All Categories</SelectItem>
                  ...
                  <div>
                    ...
                    <Select value={filters.element || undefined} onValueChange={(v) => handleFilterChange('element', v === 'all' ? '' : v)}>
                      ...
                      <SelectContent style={{ backgroundColor: logoColors.blackAlpha(0.9), borderColor: logoColors.primaryBlueAlpha(0.3) }}>
                        ...
                        <SelectItem value="wood" className="text-white hover:opacity-80 focus:bg-transparent data-[highlighted]:bg-transparent" style={{ backgroundColor: logoColors.primaryBlueAlpha(0.1) }}>Wood</SelectItem>
                        <SelectItem value="void" className="text-white hover:opacity-80 focus:bg-transparent data-[highlighted]:bg-transparent" style={{ backgroundColor: logoColors.primaryBlueAlpha(0.1) }}>Void</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div>
                    ...
                    <Select value={filters.rarity || undefined} onValueChange={(v) => handleFilterChange('rarity', v === 'all' ? '' : v)}>
                      ...
                      <SelectContent style={{ backgroundColor: logoColors.blackAlpha(0.9), borderColor: logoColors.primaryBlueAlpha(0.3) }}>
                        <SelectItem value="all" className="text-white hover:opacity-80 focus:bg-transparent data-[highlighted]:bg-transparent" style={{ backgroundColor: logoColors.primaryBlueAlpha(0.1) }}>All Rarities</SelectItem>
